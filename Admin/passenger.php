      ...
      <div class="container-fluid">
          <div class="card card-primary">
              <div class="card-header">
                  <h3 class="card-title">Add new Passenger</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="addship.php" method="post">
                  <div class="card-body">
                      ...
                      <div class="form-group">
                          <label for="exampleInputPassword1">Embarkation</label>
                          <input type="text" class="form-control" name="embarkation" placeholder="Embarkation">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputPassword1">Disembarkation</label>
                          <input type="text" class="form-control" name="disembarkation" placeholder="Disembarkation">
                      </div>
