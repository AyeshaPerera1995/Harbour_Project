                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <div class="icon">
                                <i class="ion ion-add-circle"></i>
                            </div>
                            <a href="save_notification.php" class="small-box-footer">Complete Information <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
