                        ...
                        <div class="card card-success">
                            ...
                            <form role="form" action="cargo.php" method="post">
                                <div class="card-body">
                                    <div role="form">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label >First port of arrivel in EU</label>
                                                    <input type="text" class="form-control" name="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <button type="submit" name="btnEV" class="btn btn-dark">View/Edit</button>
                                        <button type="submit" name="btnDel" class="btn btn-dark">Delete</button>
                                        <br><br>
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="ship_voyage_upload" class="btn btn-danger"><i class="fas fa-upload"></i>   Upload</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
